...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("disciplinary_frame", postgresql.ENUM(name="disciplinary_frame_enum", create_type=False), nullable=True),
        sa.Column("provenance_quality", postgresql.ENUM(name="provenance_quality_enum", create_type=False), nullable=False, server_default="unknown"),
    ...
    op.create_table(
        ...
        sa.Column("context", postgresql.ENUM(name="account_context_enum", create_type=False), nullable=True),
        sa.Column("corroboration", postgresql.ENUM(name="corroboration_level_enum", create_type=False), nullable=False, server_default="none"),
    ...
    op.create_table(
        ...
        sa.Column("category", postgresql.ENUM(name="tag_category_enum", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("epistemic_status", postgresql.ENUM(name="epistemic_status_enum", create_type=False), nullable=False, server_default="asserted"),
    ...
    op.create_table(
        ...
        sa.Column("concept_type", postgresql.ENUM(name="concept_type_enum", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("relationship_type", postgresql.ENUM(name="relationship_type_enum", create_type=False), nullable=False),
        sa.Column("strength", postgresql.ENUM(name="relationship_strength_enum", create_type=False), nullable=True),
        sa.Column("notes", sa.Text, nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("description", sa.Text, nullable=True),
        sa.Column("framework", postgresql.ENUM(name="hypothesis_framework_enum", create_type=False), nullable=False),
        sa.Column("assumed_ontologies", postgresql.JSONB, nullable=True),
        sa.Column("required_assumptions", postgresql.JSONB, nullable=True),
        sa.Column("status", postgresql.ENUM(name="hypothesis_status_enum", create_type=False), nullable=False, server_default="active"),
        sa.Column("notes", sa.Text, nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        "epistemic_notes",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("attached_to_type", postgresql.ENUM(name="attachable_entity_type_enum", create_type=False), nullable=False),
        sa.Column("attached_to_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("note_type", postgresql.ENUM(name="epistemic_note_type_enum", create_type=False), nullable=False),
